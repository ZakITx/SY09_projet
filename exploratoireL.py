...
top_10_artist = (
    top_10_artist.groupby(["artist(s)_name"])["streams"]
    .sum()
...
# %%
sns.scatterplot(x="artist_count", y="streams", data=feat_songs)
...
feat_songs_by_artist_count = (
    feat_songs_by_artist_count.groupby("artist_count").count().reset_index()
)
feat_songs_by_artist_count
